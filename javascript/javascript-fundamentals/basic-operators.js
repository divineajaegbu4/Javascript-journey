...
const sumFruits = apples + oranges
...
const sameAge = ++age // pre-increment
...
const sameNewAge = newAge++ // post-increment
...
const a1 = prompt('First number?', 1)
const b1 = prompt('Second number?', 2)

// Short but not clear
// alert(+a1 + +b1); // 12

// Best for readability and recommended one
const convert1 = Number(a1)
const convert2 = Number(b1)
